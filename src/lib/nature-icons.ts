const NATURE_ICONS: Record<string, { imagePath: string; className: string }> = {
  ...
  Yin:        { imagePath: '/nature-icons/nature-icon-yin.webp',       className: 'bg-purple-800' },
  Yang:       { imagePath: '/nature-icons/nature-icon-yang.webp',      className: 'bg-orange-300' },
  'Yin-Yang': { imagePath: '/nature-icons/nature-icon-yin-yang.webp',  className: 'bg-gray-700' },
}
