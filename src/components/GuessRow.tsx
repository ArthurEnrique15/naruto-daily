    ...
    <tr>
      <td className="p-1">
        ...
        >
          ...
          {/* Styled tooltip */}
          <div className="absolute bottom-full mb-1 left-1/2 -translate-x-1/2 z-20 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-150">
